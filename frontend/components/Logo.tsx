...
// Diploma glyph shared with the favicon (app/icon.svg) so the in-app mark
// matches the browser tab icon. Inherits color via currentColor.
...
export default function Logo({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        <LogoGlyph size={iconW} className="text-paper" />
      </div>
      {!iconOnly && (
