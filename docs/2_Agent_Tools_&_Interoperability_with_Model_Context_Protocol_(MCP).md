...
Agent Tools & Interoperability with MCPNovember 2025Table of contents
...
Agent Tools & Interoperability with MCPNovember 2025With the advent of Agentic AI, tools become even more important to AI systems. An AI Agent
...
Agent Tools & Interoperability with MCPNovember 2025requests, by accessing structured and unstructured data sources; or, tools can perform an
...
Agent Tools & Interoperability with MCPNovember 2025
...
Agent Tools & Interoperability with MCPNovember 2025Python
...
Querying databases, spreadsheets, or
other structured data sources (e.g., MCP
Toolbox, NL2SQL)

Define clear schemas, optimize for efficient
querying, handle data types gracefully.

Unstructured Data
Retrieval

Searching documents, web pages, or
knowledge bases (e.g., RAG sample)
...
Interacting with Google Workspace apps
(e.g., Gmail, Drive, Calendar)
...
Implement robust search algorithms,
consider context window limitations, and
provide clear retrieval instructions.

Ensure template parameters are well-
defined, provide clear guidance on
template selection.

Leverage Google APIs, ensure proper
authentication and authorization, handle
API rate limits.

Document external API secifications,
manage API keys securely, implement error
...
Agent Tools & Interoperability with MCPNovember 2025•  Add targeted examples: Examples can help address ambiguities, show how to handle
...
Agent Tools & Interoperability with MCPNovember 2025Design for concise output
...
Agent Tools & Interoperability with MCPNovember 2025also be provided to the calling LLM, so it provides another avenue for giving instructions.
...
Agent Tools & Interoperability with MCPNovember 2025of external tools and data. By standardizing this communication layer, MCP aims to decouple
...
Agent Tools & Interoperability with MCPNovember 2025Figure 2:  MCP Host, Client and Server in an Agentic Application
...
Agent Tools & Interoperability with MCPNovember 2025Base Protocol: MCP uses JSON-RPC 2.0 as its base message format. This gives it a
...
Agent Tools & Interoperability with MCPNovember 2025Figure 3: MCP Transport Protocols
...
Agent Tools & Interoperability with MCPNovember 2025• openWorldHint: May interact with an "open world" of external entities (default: true).
...
Agent Tools & Interoperability with MCPNovember 2025While they do have the potential to add value to an AI system, in a distributed enterprise
...
Agent Tools & Interoperability with MCPNovember 2025Elicitation
...
Agent Tools & Interoperability with MCPNovember 2025used in a production MCP system. For one thing, there are no guardrails in the specification
...
Agent Tools & Interoperability with MCPNovember 2025MCP Registry30, which provides both a central source of truth for public MCP servers, and
...
Agent Tools & Interoperability with MCPNovember 2025Foundations for Governance and Control
...
Agent Tools & Interoperability with MCPNovember 2025Performance and Scalability Bottlenecks
...
Agent Tools & Interoperability with MCPNovember 2025This would transform tool discovery from a static, brute-force loading process into a
...
Agent Tools & Interoperability with MCPNovember 2025MCP was designed for open, decentralized innovation, which spurred its rapid growth, and
...
Agent Tools & Interoperability with MCPNovember 2025As a standard agent protocol, MCP is being used for a broad range of applications,
...
Agent Tools & Interoperability with MCPNovember 2025retrieved via a tools/list request. MCP Servers are also not required to notify clients when
...
Agent Tools & Interoperability with MCPNovember 2025•  Host MCP servers in a controlled environment: Dynamic capability injection is a risk
...
Agent Tools & Interoperability with MCPNovember 2025•  Description: "Saves any important data from the user to a private, secure repository. Use
...
Agent Tools & Interoperability with MCPNovember 2025•  Restrict Access to Unauthorized MCP Servers: In the example above the coding
...
Agent Tools & Interoperability with MCPNovember 2025•  Separate System Prompts: Clearly separate user inputs from system instructions to
...
Agent Tools & Interoperability with MCPNovember 2025Mitigations
...
Agent Tools & Interoperability with MCPNovember 2025Conclusion
...
Agent Tools & Interoperability with MCPNovember 2025Appendix
...
Agent Tools & Interoperability with MCPNovember 2025The MCP server has been granted extensive privileges to the code repository to perform
...
Agent Tools & Interoperability with MCPNovember 2025The Result
...
Agent Tools & Interoperability with MCPNovember 2025Endnotes
...
Agent Tools & Interoperability with MCPNovember 202513.  "Code Execution", Gemini API Docs, Google (2025),
...
Agent Tools & Interoperability with MCPNovember 202525. "Server Features: Prompts", Model Context Protocol Specification, Anthropic (2025),
...
Agent Tools & Interoperability with MCPNovember 202536. Milanta, Marco, and Luca Beurer-Kellner, "GitHub MCP Exploited: Accessing private repositories via
